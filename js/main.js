...
tlv_data = [
{
	"he": {
		...
		"pre_nav_msg": "כניסה לאופנועים בלבד - להכנס לחוף הצוק צפון / חוף מנדרין ולפנות ימינה (צפונה) עד לסוף הטיילת הסלולה. מכוניות/אופנועים - לנסוע צפונה דרך החניה לאורך הצוק עד לסוף הגדר (משמאל), משם ניתן לרדת (בזהירות!) מהצוק לכיוון החוף."
	},
	...
	"approx_address": "הצוק הצפוני 20",
	"restaurants": ["MeEver Laktaze", "Espresso Bar (@Mandarin)"],
	"hotels": ["Mandarin"],
	"notes_access": "",
	"landmarks": ["Lifeguard Hut #26"],
	"has_lifeguard": true,
	"is_official": true,
	"has_gates": true,
	...
	"he": {
		...
		"notes_access": "שלוש דרכי הגעה: מכיוון צפון - ברגל, יש להתקדם דרומה מחוף צוק צפון / סי אנד סאן; מכיוון מרכז - ברגל, לרדת מהכביש לבסיס הצבאי 150 מ' דרומית לתחנת דלק פז 'למד' על כביש 2040; כניסה דרומית - ברגל, להתקדם צפונה מהחניה של חוף תל ברוך",
		"landmarks": ["תחנת דלק פז 'למד'","בסיס צבאי"],
		"pre_nav_msg": "גישה דרך הרחוב, 150 מ' מדרום לתחנת דלק פז 'למד'. אופנועים יכולים להמשיך 250 מ' במעלה הגבעה לכיוון הבסיס הצבאי. יש לעצור בעיקול הכביש ולרדת בזהירות ברגל. יש לעצור במחסום ולהקדם ברגל."
	},
	"name": "Tsukei Aviv",
	"lat": "32.129484",
	"lon": "34.786695",
	...
	"restaurants": [],
	"hotels": [],
	"notes_access": "300m south of Tel Baruch car park. Access on foot or motorcycle via tayelet/cycle path.  Entrance to Kite Beach is opposite the RED GATE found on the airport-side of tayelet.",
	...
	"restaurants": [],
	"hotels": [],
	"notes_access": "500m south of Tel Baruch car park. Access on foot or motorcycle via tayelet/cycle path.  Entrance to Dog Beach is opposite the WATCHTOWER found on the airport-site of tayelet. Access road available to motorcycles only.",
	...
	"he": {
		...
		"restaurants": ["קיטשן מרקט (Hanger 12)","ארומה (האנגר 9)","קפה נימרוד ובני הדייג (האנגר 8)"],
	...
	"he": {
		...
		"notes_access": "",
		"landmarks": ["תחנת עזרה ראשונה (מלבד סוכת המציל) ב <a class='' href='http://www.google.com/maps/place/32.09473,34.772405' target='_blank'>32.09473,34.772405</a>"],
		"pre_nav_msg": ""
	},
	"name": "Metzitzim",
	"lat": "32.09387091",
	...
	"notes_access": "",
	"landmarks": ["First Aid Station (separate to lifeguard hut) at <a class='' href='http://www.google.com/maps/place/32.09473,34.772405' target='_blank'>32.09473,34.772405</a>"],
	"has_lifeguard": true,
	"has_firstaid": true,
	"is_official": true,
	"has_gates": false,
	...
	"he": {
		...
		"notes_access": "גישה לאופנועים רק דרך הרמפה מצפון, מול רח' נודראו (<a class='' href='http://www.google.com/maps/place/32.09218712,34.77260292' target='_blank'>32.09218712,34.77260292</a>); או מכיוון דרום מול רח' ז'בוטינסקי; או מימין למלון הילטון דרך כביש הגישה של החניה (<a class='' href='http://www.google.com/maps/place/32.08995791,34.77214158' target='_blank'>32.08995791,34.77214158</a>)",
		"landmarks": ["Playground (<a class='' href='http://www.google.com/maps/place/32.09045784,34.77125108' target='_blank'>32.09045784,34.77125108</a>)","Embassy of Switzerland"],
		"pre_nav_msg": "Motorcycle access IS ONLY via ramps at North (opposite Nordau @ 32.09218712,34.77260292) and South (opposite Jabotinsky, to the right of the Hilton Parking Service Road @ 32.08995791,34.77214158)"
	},
	...
	"notes_access": "Motorcycle access ONLY via ramps at North opposite Nordau (<a class='' href='http://www.google.com/maps/place/32.09218712,34.77260292' target='_blank'>32.09218712,34.77260292</a>) and South opposite Jabotinsky, to the right of the Hilton Parking Service Road (<a class='' href='http://www.google.com/maps/place/32.08995791,34.77214158' target='_blank'>32.08995791,34.77214158</a>)",
	"landmarks": ["Playground (<a class='' href='http://www.google.com/maps/place/32.09045784,34.77125108' target='_blank'>32.09045784,34.77125108</a>)","Embassy of Switzerland"],
	"has_lifeguard": "",
	"is_official": "",
	"has_gates": false,
	...
	"landmarks": ["Seawall with wooden promenade and sea entrance to Tel Aviv Marina (to the South)", "Marine Police (to the South)", "Yamit Rental (to the South)", "LevYam Sailing/Windsurf School (to the North)", "Sea Center (to the North)"],
	"has_lifeguard": false,
	"is_official": false,
	"has_gates": true,
	"motorcycle_access": true,
	...
	"landmarks": ["Mosquito statue (32.08853083, 34.77055371)", "Hilton HaAtzmaut Bridge - South (Above Emanuel Sela / Above entrance to Hilton)", "Hilton HaAtzmaut Bridge - North (Above 1174 / Above service entrance to Hilton / Opposite Jabotinsky)", "Opposite British Embassy"],
	"has_lifeguard": "",
	"is_official": "",
	"has_gates": "",
	"motorcycle_access": true,
	...
	"he": {
		...
		"notes_access": "כניסה מכיוון צפון: כניסה לאופנועים דרך הרמפה לכיוון הטיילת מחוץ למלון רנסנס; כניסה מכיוון דרום: פנית פרסה ברח' הירקון ליד מלון שרתון, יש לעצור בכניסה לטיילת / חניון, מול שגרירות צרפת, ליד קפה לונדון",
		"landmarks": ["סריכת גורדון", "שגרירות צרפת"],
		"pre_nav_msg": "כניסה מכיוון צפון: כניסה לאופנועים דרך הרמפה לכיוון הטיילת מחוץ למלון רנסנס; כניסה מכיוון דרום: פנית פרסה ברח' הירקון ליד מלון שרתון, יש לעצור בכניסה לטיילת / חניון, מול שגרירות צרפת, ליד קפה לונדון"
	},
	"name": "Gordon",
	"lat": "32.082569",
	"lon": "34.767216",
	...
	"notes_access": "From North only:<br>Motorbikes should take ramp down to the tayelet from outside the Renaissance Hotel.<br><br>From South:<br>U-turn on HaYarkon at Sheraton Hotel and stop at the entrance to the tayelet/car park. Opposite French Embassy. Next to Cafe London.",
	...
	"he": {
		...
		"pre_nav_msg": "מכוניות / אמבולנסים - כניסה מצפון בכניסה הצפונית של החניון (32.06769015, 34.76285309). מכל הכיוונים בכניסה המרכזית לחניון (32.06290544, 34.76141542), מול רח' שנקר. מכיוון דרום במוזיאון האצ\"ל (32.05929344, 34.75937158) ברח' נחום גולדמן",
		"parking": ["דולפינריום"]		
	},
	...
	"car_access": false,
	"parking": ["Dolphinarium"],
	"pre_nav_msg": "Cars/Ambulances - From North @ Car Park North Entrance (32.06769015, 34.76285309).  From all directions @ Car Park Central Entrance (32.06290544, 34.76141542) opposite Shenkar Street. From South @ Etzel Museum (32.05929344, 34.75937158) on Nahum Goldmann St.",
	"type": "park"
},{
	"he": {
		"name": "מאנטה ריי",
	...
	"he": {
		...
		"restaurants": ["מנטה ריי"],
		"notes_access": "הכניסה עם רכב לחניון בית האצ\"ל- נחום גולדמן 4 תל אביב",
		"landmarks": ["סוכת מציל #4", "תחנת עזרה ראשונה (ליד מנטה ריי) ב <a class='' href='http://www.google.com/maps/place/32.0615554,34.7599461' target='_blank'>32.0615554,34.7599461</a>"],
		"pre_nav_msg": "מכוניות/אמבולנסים - גישה מכיוון דרום במוזיאון האצ\"ל, ברח' נחום גולדמן",
		"parking": ["דולפינריום"]
	},
	"name": "Charles Clore",
	...
	"hotels": [],
	"notes_access": "",
	"landmarks": ["Lifeguard Hut #4", "First Aid Station (next to Manta Ray) at <a class='' href='http://www.google.com/maps/place/32.0615554,34.7599461' target='_blank'>32.0615554,34.7599461</a>"],
	"has_lifeguard": true,
	"has_firstaid": true,
	"is_official": true,
	"has_gates": true,
	...
	"landmarks": ["Blue footbridge at <a class='' href='http://www.google.com/maps/place/32.0582139,34.757866' target='_blank'>32.0582139,34.757866</a>"],
	"has_lifeguard": "",
	"is_official": "",
	"has_gates": true,
	"motorcycle_access": true,
	...
	"he": {
		...
		"hotels": [],
		"notes_access": "מכוניות/אמבולנס - גישה דרך כניסה ראשית בנמל יפו / רח' יהודה הימית (<a class='' href='http://www.google.com/maps/place/32.0521581,34.7502533' target='_blank'>(32.0521581,34.7502533)</a>), בין האנגר 1 (חדש) להאנגר 2 (ישן)",
		"landmarks": ["נמל יפו", "מרכז נא לגעת"],
		"pre_nav_msg": "",
		"parking": ["חניון נמל יפו - מדרום לנמל <a class='' href='http://www.google.com/maps/place/32.0500092,34.7486924' target='_blank'>(32.0500092,34.7486924)</a>"],
	...
	"hotels": [],
	"notes_access": "Cars/Ambulances - Access via main entrance @ Nemal Yafo St / Yehuda Hayamit St <a class='' href='http://www.google.com/maps/place/32.0521581,34.7502533' target='_blank'>(32.0521581,34.7502533)</a> between Hanger 1 (new) and Hanger 2 (old)",
	...
	"motorcycle_access": true,
	"car_access": true,
	"parking": ["Jaffa Port Parking - South of Jaffa Port <a class='' href='http://www.google.com/maps/place/32.0500092,34.7486924' target='_blank'>(32.0500092,34.7486924)</a>"],
	"pre_nav_msg": "",
	"type": "beach_unofficial_port"
},{
	"he": {
		...
		"hotels": [],
		"notes_access": "כניסה דרך נתיב אופניים בלבד דרך גן המדרון. כניסה: מנמל יפו (צפון) - הולכי רגל/אופנועים בלבד דרך חניון נמל יפו [<a class='' href='http://www.google.com/maps/place/32.047939,34.747746' target='_blank'>(32.047939,34.747746)</a>]. מיפו (מרכז) - הולכי רגל/אופנועים בלבד דרך בי\"ס חסן ערפה (קדם 49) או חניון צופית (קדם 73) [<a class='' href='http://www.google.com/maps/place/32.044637,34.7475555' target='_blank'>(32.044637,34.7475555)</a>]. מיפו (דרום) - חניון חול מול הזקן והים (קדם 82) [] או חניון ציבורי (קדם 94 פינת מנדס פרנס). החוף מדרום לגן המדרון נגיש למכוניות/אמבולנס מתחת לבאבי ובית סידי [<a class='' href='http://www.google.com/maps/place/32.04034915,34.74552602' target='_blank'>32.04034915,34.74552602.</a>]",
		"landmarks": ["גינת משחקים [<a class='' href='http://www.google.com/maps/place/32.0464514,34.74703342' target='_blank'>(32.0464514, 34.74703342)</a>]", "גישה דרך נמל יפו או בי\"ס חסן ערפה (רח' קדם 49), גינת טולוז"],
		"parking": ["נמל יפו (צפון) [<a class='' href='http://www.google.com/maps/place/32.047939,34.747746' target='_blank'>(32.047939,34.747746)</a>]", "צופית (דרום) [<a class='' href='http://www.google.com/maps/place/32.044637,34.7475555' target='_blank'>(32.044637,34.7475555)</a>]"]
	},
	...
	"hotels": [],
	"notes_access": "Access only via cycle paths through Midron Park. Entrances: From Yafo Port (North): Motorcycles/foot only via Jaffa Port Parking <a class='' href='http://www.google.com/maps/place/32.047939,34.747746' target='_blank'>(32.047939,34.747746)</a>. From Yafo (Central): Motorcycles/foot only south of Hassan Arfa School (49 Kedem St) or Tsofit Parking at 73 Kedem St <a class='' href='http://www.google.com/maps/place/32.044637,34.7475555' target='_blank'>(32.044637,34.7475555)</a>. From Yafo (South): Sand parking opposite HaZaken Ve HaYam at Kedem 82 <a class='' href='http://www.google.com/maps/place/32.043313,34.747285' target='_blank'>(32.043313,34.747285)</a> or Public Parking at Kedem 94 (corner of Mendes-France). The beach at the southern end of Midron Park can be accessed by car/ambulance below Babai and Beit Sidi at <a class='' href='http://www.google.com/maps/place/32.04034915,34.74552602' target='_blank'>32.04034915,34.74552602.</a>",
	"landmarks": ["Playground <a class='' href='http://www.google.com/maps/place/32.0464514,34.74703342' target='_blank'>(32.0464514, 34.74703342)</a> access via Yafo Port Parking or Hassan Arfa School", "Hassan Arfa School (49 Kedem St)", "Toulouse Garden"],
	"has_lifeguard": "",
	"is_official": "",
	"has_gates": true,
	"motorcycle_access": true,
	"car_access": false,
	"parking": ["Jaffa Port (North) <a class='' href='http://www.google.com/maps/place/32.047939,34.747746' target='_blank'>(32.047939,34.747746)</a>", "Tsofit (South) <a class='' href='http://www.google.com/maps/place/32.044637,34.7475555' target='_blank'>(32.044637,34.7475555)</a>"],
	"pre_nav_msg": "",
	"type": "park"
},{
	"he": {
...
buildAddressLink = function (thisPlaceObj, placeAttribute, lang = "en", iconHTML, URL) {
			...
			'<div class="top-info-row row row-eq-height place-row">' +
				'<div class="place-detail col-xs-12">' + 
					'<span class="info-item approx_address en">' + 					
						buildAddressLink( data[i], "approx_address", "en", '<i class="fa fa-fw fa-map-o"></i>', "http://www.google.com/maps/place/"+data[i].approx_address.replace(/ /g,'+')+"/" ) +  
					'</span>' +
					'<span class="info-item approx_address he">' + 
						buildAddressLink( data[i], "approx_address", "he", '<i class="fa fa-fw fa-map-o"></i>', "http://www.google.com/maps/place/"+data[i].approx_address.replace(/ /g,'+')+"/" ) +  
					'</span>' +
